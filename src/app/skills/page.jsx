...
const desc = "Technical skills across backend, frontend, cloud, and databases — Java, Spring Boot, AWS, React, PostgreSQL, MongoDB, and more.";

export const metadata = {
    title: `Skills | ${SITE_NAME}`,
    description: desc,
    openGraph: { title: `Skills | ${SITE_NAME}`, description: desc, url: `${SITE_URL}/skills`, siteName: SITE_NAME, type: "website" },
    twitter: { card: "summary", title: `Skills | ${SITE_NAME}`, description: desc },
